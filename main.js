...
const test = new ScrollAnimation(element, window, 'test');
...
// function createAnimationKeyframe(numProps,scrollStart,scrollEnd){
...
// function a_fillUndefined(props, element, animationMap, map){
//     const origin = props;
//     const ele    = element;
//     return Object.keys(origin).reduce((acc, item, idx) => {
//         const undfKeys = hasUndefined(origin[item]);
//         undfKeys.forEach(key => {
//             const [prev, prevKey] = a_findPrevValue(origin, ele, key, idx, animationMap, map);
//             const [next, nextKey] = a_findNextValue(origin, ele, key, idx, animationMap, map);
//             const [prevNum, nextNum] = [parseInt(prevKey), parseInt(nextKey)];
//             const diff = nextNum - prevNum;
...
//     },JSON.parse(JSON.stringify(origin)));
// }
// function a_findPrevValue(props,element,value,idx,animationMap,map){
...
//     }
// }
// function a_findNextValue(props,element,value,idx,animationMap,map){
